...
chocolates_sim3 = [
    # Subset of chocolates from Simulation 2 for scarcity
...
# Distribute among 8 students to create a scenario with more students than chocolates
distribution_sim3 = distribute_chocolates(chocolates_sim3, 8)

# Sort chocolates for each student by weight and display
sorted_distribution_sim3 = {student: sort_chocolates_by_weight(chocs) for student, chocs in distribution_sim3.items()}

# Display distribution and sorting results
print("Simulation 3: Distribution and Sorting Results")
display_distribution(sorted_distribution_sim3)

# Search for "Dark chocolate" in each student's chocolates and display results
print("\nSimulation 3: Search Results")
for student in sorted_distribution_sim3:
    search_result = search_chocolates_by_type(sorted_distribution_sim3[student], "Dark chocolate")
    print(f"\nSearching for Dark chocolate in {student}'s chocolates:")
