...
chocolates_sim2 = [
    ...
    # Adding more chocolates for variety
    Chocolate(8, 5, "Mint chocolate", "006"),
    Chocolate(10, 7, "Caramel chocolate", "007"),
    Chocolate(2, 1.5, "Hazelnut chocolate", "008"),
    Chocolate(9, 6, "Berry chocolate", "009"),
    Chocolate(1, 0.5, "Sugar free chocolate", "010")
]

# Distribute among 4 students
distribution_sim2 = distribute_chocolates(chocolates_sim2, 4)

# Sort chocolates for each student by weight and display
sorted_distribution_sim2 = {student: sort_chocolates_by_weight(chocs) for student, chocs in distribution_sim2.items()}

# Display distribution and sorting results
print("Simulation 2: Distribution and Sorting Results")
display_distribution(sorted_distribution_sim2)

# Search for "Mint chocolate" in each student's chocolates and display results
print("\nSimulation 2: Search Results")
for student in sorted_distribution_sim2:
    search_result = search_chocolates_by_type(sorted_distribution_sim2[student], "Mint chocolate")
    print(f"\nSearching for Mint chocolate in {student}'s chocolates:")
